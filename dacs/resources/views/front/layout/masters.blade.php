...
<div class="offcanvas-menu-wrapper">
    ...
    <div class="offcanvas__nav__option">
        <a href="#" class="search-switch"><img src="{{url('front/fronts/img/icon/search.png')}}" alt=""></a>
        <a href="#"><img src="front/fronts/img/icon/heart.png" alt="">name</a>
        <a href="#"><img src="front/fronts/img/icon/cart.png" alt=""> <span>0</span></a>
        <img src="front/fronts/img/icon/cart.png" alt="">
        <div class="price"></div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-7">
                    <div class="header__top__left">
                        <p>Free shipping, 30-day return or refund guarantees.</p>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3">
                <div class="header__nav__option">
                    <a href="" class="search-switch"><img src="front/fronts/img/icon/search.png" alt=""></a>
                    <a href="#"><img src="front/fronts/img/icon/heart.png" alt=""></a>
                    <a href="./cart"><img src="front/fronts/img/icon/cart.png" alt=""><span class="cart-count">{{Cart::count()}}</span></a>
